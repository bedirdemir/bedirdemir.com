  ...
  >
    <div class="flex justify-between items-center">
      ...
      <div class="flex gap-4 lg:gap-4">
        <button
          ...
          class="block lg:hidden opacity-70 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-500"
        >
          <svg
            class="size-6"
    ...
    <div class="flex gap-4 items-center">
      <AppNavigation
        :id="navigationId"
        @click="navToggle"
        class="hidden lg:block mt-4 lg:mt-0"
        :class="{ '!block': isOpen }"
      />
      <button
        type="button"
        @click="colorModeToggle"
        aria-label="Tema değiştir"
        class="hidden lg:block opacity-70 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-500"
      >
        <svg
          class="size-6"
          xmlns="http://www.w3.org/2000/svg"
